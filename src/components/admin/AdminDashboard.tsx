...
import AdminWhatsAppDashboard from './AdminWhatsAppDashboard';
...
type TabType = 'overview' | 'agents' | 'listings' | 'notifications' | 'emails' | 'whatsapp';
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center">
      <div className={`bg-gray-50 w-full ${activeTab === 'emails' || activeTab === 'whatsapp' ? 'max-w-3xl' : 'max-w-lg'} max-h-[95vh] overflow-hidden rounded-t-2xl sm:rounded-2xl animate-slide-up flex flex-col transition-all duration-300`}>
        <div className="bg-white p-4 border-b border-gray-200">
          ...
          <div className="flex gap-2 overflow-x-auto pb-1">
            {(['overview', 'notifications', 'emails', 'whatsapp', 'agents', 'listings'] as TabType[]).map((tab) => (
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {activeTab === 'whatsapp' && <AdminWhatsAppDashboard />}
